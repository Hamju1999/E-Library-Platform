...
import 'package:skylibrary/Books%20Reserved/TechHB.dart';
import 'package:skylibrary/Home.dart';

void main() => runApp(const ReserveTechHB());

class ReserveTechHB extends StatelessWidget {
  const ReserveTechHB({Key key}) : super(key: key);
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: FlatButton(
              onPressed: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => TechHB())),
              child: Column(
                children: <Widget>[
