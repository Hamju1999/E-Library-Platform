...
import 'package:skylibrary/Books%20Reserved/ITE.dart';
import 'package:skylibrary/Home.dart';

void main() => runApp(const ReserveITE());

class ReserveITE extends StatelessWidget {
  const ReserveITE({Key key}) : super(key: key);
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: FlatButton(
              onPressed: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => ITE())),
              child: Column(
                children: <Widget>[
