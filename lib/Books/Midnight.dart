...
import 'package:skylibrary/Books%20Reserved/ReserveMidnight.dart';
import 'package:skylibrary/GeneralBooks.dart';

void main() => runApp(const Midnight());

class Midnight extends StatelessWidget {
  const Midnight({Key key}) : super(key: key);
                  ...
                  actions: <Widget>[
                    RaisedButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => ReserveMidnight())),
