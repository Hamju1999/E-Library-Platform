...
import 'package:skylibrary/Books%20Reserved/ReserveStrategy.dart';
import 'package:skylibrary/GeneralBooks.dart';

void main() => runApp(const BusinessStrategy());

class BusinessStrategy extends StatelessWidget {
                ...
                builder: (BuildContext context) => AlertDialog(
                  ...
                  actions: <Widget>[
                    RaisedButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => ReserveStategy())),
