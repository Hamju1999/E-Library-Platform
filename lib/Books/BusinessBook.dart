...
import 'package:skylibrary/Books%20Reserved/ReserveBusiness.dart';
import 'package:skylibrary/GeneralBooks.dart';

void main() => runApp(const BusinessBook());

class BusinessBook extends StatelessWidget {
  const BusinessBook({Key key}) : super(key: key);
                  ...
                  actions: <Widget>[
                    RaisedButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => ReserveBusiness())),
